...
### Requirement: Apply Page Forces Light Mode
**Reason**: Creates inconsistent user experience and overrides user preference
**Migration**: No migration needed - pages now respect global theme setting
